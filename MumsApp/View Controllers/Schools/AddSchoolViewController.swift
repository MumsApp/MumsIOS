...
class AddSchoolViewController: UIViewController {
    ...
    private func configureNavigationBar() {
        ...
        let titleLabel = self.navigationController?.configureNavigationBarWithTitle(title: "Add school")
    ...
    private func registerCells() {
        ...
        self.tableView.registerNib(AddSchoolCell.self)
...
extension AddSchoolViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(AddSchoolCell.self, indexPath: indexPath)
...
extension AddSchoolViewController: UISearchBarDelegate {
