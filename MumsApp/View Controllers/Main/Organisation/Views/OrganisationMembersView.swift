...
class OrganisationMembersView: UIView {
    ...
    private func commonInit() {
        ...
        Bundle.main.loadNibNamed("OrganisationMembersView", owner: self, options: nil)
...
extension OrganisationMembersView: UICollectionViewDelegate, UICollectionViewDataSource {
